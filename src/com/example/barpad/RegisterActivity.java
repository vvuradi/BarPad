...
public class RegisterActivity extends Activity {
	 ...
	 */
	//private static final String[] DUMMY_CREDENTIALS = new String[] {"a@a.a:hello", "bar@example.com:world" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*signUp.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String getPwd = mPasswordView.getText().toString();
				dbHandler = new DataHandler(getBaseContext());
				dbHandler.open();
				long insertOutput = dbHandler.insertData(getEmail, getPwd);
	...
	public void attemptLogin() {
		...
		}else 
		{
			...
			for(int i =0;i<mEmail.length();i++){
				...
				mEmailView.setError(getString(R.string.error_field_email_length));
				focusView = mEmailView;
				cancel = true;
			}
			else if(atCount>1){
	...
	public void attemptRegister() {
		// Reset errors.
		System.out.println("Entered attempt Register");
		mEmailView.setError(null);
		mPasswordView.setError(null);
		...
		System.out.println("Pwd entered : "+mPassword);		
		mUserName = mUserNameView.getText().toString();
		System.out.println("Username : "+mUserName);		
		mFirstName= mFirstNameView.getText().toString();
		System.out.println("FirstName Entered : "+mFirstName);		
		mMiddleName = mMiddleNameView.getText().toString();
		System.out.println("mMiddleName Entered : "+mMiddleName);	
		mLastName = mLastNameView.getText().toString();
		System.out.println("mLastName Entered : "+mLastName);
		mTelephone = mTelephoneView.getText().toString();
		System.out.println("mTelephone Entered : "+mTelephone);
		boolean cancel = false;
		View focusView = null;
		...
		if (cancel) {
			...
			long insertOutput = dbHandler.insertDataUserDetails(mEmail, mUserName, mPassword,mFirstName,mMiddleName, mLastName,mTelephone);
			System.out.println("Response from DB : ///////////////////////////////"+insertOutput);
			Toast.makeText(getBaseContext(), "Data Inserted", Toast.LENGTH_LONG).show();
			dbHandler.close();
			mAuthTask = new UserLoginTask();
			mAuthTask.execute((Void) null);
