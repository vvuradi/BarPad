...
public class DataHandler {
	...
	public static final String CLICKER_CREATE = " CREATE TABLE "
			+ CLICKER_TABLE_NAME
			+ "( "
	...
	private static class DataBaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			try {
				...
				System.out.println("query to create table : "
						+ USER_DETAILS_CREATE);
				db.execSQL(USER_DETAILS_CREATE);
				System.out.println("Table Created");
			} catch (SQLException e) {
				System.out
						.println("Exception occured in table creation : //////////////////");
				e.printStackTrace();
			}
		}
	...
	public DataHandler open() {
		...
		/*
		 * if(db != null){ System.out.println("DB is not null"); }
		 */
		return this;
	}
	...
	public long insertDataUserDetails(String email, String userName,
	...
	public long insertClickerDetails(long count, String userName, String date) {
		...
		System.out.println("Count : " + count + ", userID : " + userName
				+ " Date : " + date);
		if (db != null) {
	...
	public Cursor fetchUserDetails() {
		String[] cols = { EMAIL, PWD, "FIRST_NAME", "LAST_NAME", "USER_NAME",
				"USER_ID" };
		return db.query(USER_DETAILS_TABLE_NAME, cols, null, null, null, null,
				null);
	}
	...
	public String validateUser(String email, String password) {
		...
		if (email == null || email.length() == 0) {
			...
			Long emailRowCount = Long.valueOf(c.getLong(0));
			...
			if (emailRowCount < 0) {
				...
				System.out.println("Pwd from DB : " + pwdFromDB);
				System.out.println("Pwd entered by user : " + password);
